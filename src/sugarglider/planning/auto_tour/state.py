...
GLOBAL_OPTIMIZATION_ROUTE_REQUEST_BUDGET = 64
...
class AutoTourSettings:
    ...
    global_optimization_route_request_budget: int = (
    ...
    def __post_init__(self) -> None:
        ...
        if not 0 <= self.global_optimization_route_request_budget <= 64:
            raise ValueError("global-optimization budget must be between 0 and 64")
    ...
    def total_route_request_budget(self) -> int:
        return (
            ...
            + self.global_optimization_route_request_budget
        )
...
def _search_budget(settings: AutoTourSettings) -> SearchBudget:
    ...
    limits[SearchPhase.GLOBAL_OPTIMIZATION] = (
