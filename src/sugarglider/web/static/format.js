...
const labels = {
  ...
  edge_aware_global_optimization: "Edge-aware optimized route",
  global_optimization_budget_exhausted: "The edge-aware optimizer reached its route-call budget; the best completed routes were retained.",
  global_optimization_time_limit_reached: "The edge-aware optimizer reached its time limit; the best completed routes were retained.",
  flexible: "Flexible",
  balanced: "Balanced",
  strict: "Strict",
  ...
  maximum_requested_coverage: "Maximum requested coverage",
  smooth_low_detour: "Smooth low detour",
  distance_focused: "Distance focused",
  best_structural_refinement: "Best route-shape alternative",
  distinct_structural_refinement: "Distinct major-spur alternative",
  selected: "Selected",
  dropped: "Dropped",
  mapped_entrance: "Mapped entrance",
  mapped_gate: "Mapped gate",
  public_path_boundary: "Public-path boundary",
  nearby_public_path: "Nearby public path",
  strict_graph_snap: "Strict graph snap",
  user_override: "User approach override",
  requested_must_visit: "Requested must-visit",
  requested_preferred: "Requested preferred",
  arrival_tolerance_not_met: "Arrival tolerance not met",
  no_meaningful_approach: "No meaningful approach",
  approach_snap_too_far: "Approach snap too far",
  private_or_restricted: "Private or restricted",
  graph_unreachable: "Graph unreachable",
  search_budget_exhausted: "Search budget exhausted",
  maximum_distance_rejected: "Maximum distance rejected",
  lower_utility_candidate: "Selected by another candidate trade-off",
