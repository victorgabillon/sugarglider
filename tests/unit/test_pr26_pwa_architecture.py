...
def test_shared_shell_generation_tracks_v27_cached_assets() -> None:
    worker = (STATIC_DIRECTORY / "service-worker.js").read_text()
    ...
    assert {
        ...
        "local_routing.js": (
            "bd4450aaf758942d411c2148defdde9a83fd1d89f7913aab6a919ed33352013e"
        ),
        "local_auto_tour.js": (
