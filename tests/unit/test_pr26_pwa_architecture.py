...
def test_shared_shell_generation_tracks_v24_cached_assets() -> None:
    worker = (STATIC_DIRECTORY / "service-worker.js").read_text()
    ...
    assert {
        ...
        "local_routing.js": (
            "dc5e6c524add852369d8b285a81aff07a10a036c065427f22515ace6e8801aa2"
        ),
        "local_auto_tour.js": (
